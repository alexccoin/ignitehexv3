...
-- Create daily rewards calculation function
...
BEGIN
  ...
  FOR pool_record IN 
    ...
    WHERE usp.balance > 0 
      ...
      AND usp.created_at <= (current_time - INTERVAL '24 hours')
  LOOP
  ...
  RAISE NOTICE 'Daily rewards calculation completed at %', current_time;
END;
$function$;

-- Schedule the daily rewards function to run at midnight every day
SELECT cron.schedule(
  'daily-staking-rewards',
  '0 0 * * *', -- At 00:00 every day
  $$
  SELECT public.calculate_daily_rewards();
  $$
);