-- Fix the validation triggers to be less restrictive for normal profile updates
...
-- Also update the enhanced validation function
...
BEGIN
  ...
  IF (TG_OP = 'INSERT' AND NEW.wallet_recovery_words IS NOT NULL) OR 
    ...
    -- Skip the complex plaintext validation for now to avoid blocking legitimate updates
