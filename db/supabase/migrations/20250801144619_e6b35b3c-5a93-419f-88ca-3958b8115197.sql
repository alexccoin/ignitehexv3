...
CREATE TYPE IF NOT EXISTS account_status AS ENUM ('pending', 'approved', 'suspended', 'closed');

-- Create user status enum  
CREATE TYPE IF NOT EXISTS user_status AS ENUM ('standard', 'silver', 'gold', 'platinum', 'vip');
