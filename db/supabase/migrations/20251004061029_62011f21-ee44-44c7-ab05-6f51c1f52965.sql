-- Improve process_staking_request to gracefully handle duplicate duration pools by upserting
...
BEGIN
  ...
  IF approve THEN
    ...
    IF request_record.request_type = 'stake' THEN
      -- First try the existing reward distribution path
      BEGIN
