-- Drop existing function and create new ones with correct parameters

-- Drop the existing function first
DROP FUNCTION IF EXISTS public.calculate_dynamic_apy(numeric, integer, numeric);

-- Create the new calculate_dynamic_apy function with correct parameter names
...
BEGIN
  ...
  WHERE enhanced_staking_pools.token_type = token_type_param
    AND enhanced_staking_pools.duration_months = duration_months_param  -- Fixed ambiguous reference
