-- Update the admin_correct_voucher_tokens function to handle all BASIC/Starter/AI package variations
...
BEGIN
  ...
  CASE voucher_record.package_type
    ...
    -- Old naming convention for STR - All BASIC variations map to Foundation
    ...
    -- Old naming convention for CCOS - All STARTER variations map to Foundation
    ...
    -- Old naming convention for ARSS - All AI variations map to Foundation
