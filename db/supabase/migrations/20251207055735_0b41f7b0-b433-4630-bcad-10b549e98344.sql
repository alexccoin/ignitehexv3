-- Recreate the admin_upsert_user_profile_status function to use UPDATE instead of upsert
-- This avoids ON CONFLICT issues while still handling status updates
...
BEGIN
  ...
  ELSE
    -- Insert new profile with placeholder values
