...
export type Database = {
  ...
  public: {
    ...
    Functions: {
      ...
      emergency_unstake_apr: {
        Args: { original_duration: number; str_amount: number }
        Returns: number
      }
      ...
      enforce_mandatory_pin_setup: { Args: never; Returns: Json }
      ...
      get_security_metrics_unified:
        | { Args: never; Returns: Json }
        | { Args: { time_period_hours?: number }; Returns: Json }
